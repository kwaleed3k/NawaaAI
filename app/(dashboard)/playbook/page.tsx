          ...
          return (
            ...
            >
              ...
              <button
                type="button"
                onClick={() => toggle(i)}
                className="flex w-full items-center gap-5 p-6 sm:p-8 text-left hover:bg-white/40 transition-colors"
              >
              ...
              >
                <div className="overflow-hidden">
                  <div className="border-t-2 border-[#e8eaef] p-6 sm:p-8 space-y-6 bg-gradient-to-b from-[#fafbfd]/80 to-white/80">
                      ...
                      return (
                        <div key={si} className="flex gap-5">
                          ...
                          <div className="flex flex-col items-center">
                            <div className={`flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-gradient-to-br ${guide.color} text-xl font-black text-white shadow-lg ${guide.glow}`}>
                              {si + 1}
                            </div>
                    ...
                    <button
                      ...
                      className={`flex items-center justify-center gap-2 w-full rounded-2xl px-6 py-3.5 text-lg font-bold transition-all duration-300 ${
                        isCompleted
